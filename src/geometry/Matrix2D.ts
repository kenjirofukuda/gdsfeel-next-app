...
export class Matrix2D {
   ...
   * @readonly
   **/
  static identity = new Matrix2D(); // set at bottom of class definition.
   ...
   *
   * 	let o = myDisplayObject;
   * 	const mtx = o.getMatrix();
   * 	while (o = o.parent) {
  ...
  appendTransform(
    ...
    regX: number,   regY: number): Matrix2D {
